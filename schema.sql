...
create table stop_times(trip_id integer, arrival_time text, departure_time text, stop_id integer, stop_sequence integer, pickup_type integer, drop_off_type integer, shape_dist_traveled real);
