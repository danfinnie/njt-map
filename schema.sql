...
create table shapes(shape_id integer, shape_pt_lat text, shape_pt_lon text, shape_pt_sequence integer, shape_dist_traveled real, primary key (shape_id, shape_pt_sequence));
